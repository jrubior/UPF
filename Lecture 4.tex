...
Under assumptions 1-4, the ordinary least squares (OLS) estimators $\hat{\beta}_0$ and $\hat{\beta}_1$  have the minimum variance among all linear unbiased estimators, making them Best Linear Unbiased Estimators (BLUE).
\end{exampleblock}
\end{frame}
...
\begin{itemize}
    ...
    \item[--] \textbf{Papers:}
    \begin{itemize}
        \item Aron-Dine, Aviva, Liran Einav, and Amy Finkelstein. "The RAND health insurance experiment, three decades later." Journal of Economic Perspectives 27.1 (2013): 197-222.
        \item Taubman, S. L., Allen, H. L., Wright, B. J., Baicker, K., \& Finkelstein, A. N. (2014). Medicaid increases emergency-department use: evidence from Oregon's Health Insurance Experiment. Science, 343(6168), 263-268.
    \end{itemize}
    %\item[--] \textbf{Additional Readings:}
\end{itemize}
\scriptsize{
