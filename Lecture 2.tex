...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Introductory Econometrics, 5th Edition, A Modern Approach, by Jeff. Wooldridge -- Appendix C.
    \end{itemize}
    \item[--] \textbf{Papers:}
    \begin{itemize}
        \item Woodbury, Stephen A., and Robert G. Spiegelman. "Bonuses to workers and employers to reduce unemployment: Randomized trials in Illinois." The American Economic Review (1987): 513-530.
        \item Kofoed, Michael, et al. "Zooming to class?: Experimental evidence on college students&Apos; online learning during Covid-19." Online Learning During COVID-19. IZA Discussion Paper 14356 (2021) -- Conditionally Accepted at The American Economic Review - Insights
    \end{itemize}
