...
\end{itemize}
\begin{eqnarray*}
    &ln(wage) &= \beta_0 + \beta_1 \mathbbm{1}_{1985} + \beta_2 Educ + \beta_3 (Educ \times \mathbbm{1}_{1985} ) + \beta_4 Female + \beta_5 (Female \times \mathbbm{1}_{1985} ) \\
...
\begin{equation*}
    Y_i = \beta_0 + \beta_1 X_{1i} + \cdots + \beta_k X_{ki} + \beta_{k+1} \mathbbm{1}_{year_2} + \beta_{k+2}  (\mathbbm{1}_{year_2} \times X_{1i}) + \cdots + \beta_{2k+1}(\mathbbm{1}_{year_2}\times X_{ki})  + u_i
\end{equation*}
...
\begin{equation*}
    Fatalities_{i,t} = \beta_0 + \delta_0\mathbbm{1}_{1988} +\beta_1 BeerTax_{i,t} + \beta_2 Z_i + u_{i,t}
\end{equation*}
...
\begin{equation*}
    Fatalities_{i,t} = \beta_0 + \delta_1\mathbbm{1}_{1983} + \delta_2\mathbbm{1}_{1984}  + \cdots +  \delta_6\mathbbm{1}_{1988} +\beta_1 BeerTax_{i,t} + \beta_2 Z_i + u_{i,t}
\end{equation*}\\[1em]

That is,
\begin{eqnarray*}
    &Fatalities_{i,1982} = \beta_0 +\beta_1 BeerTax_{i,1982} + \beta_2 Z_i + u_{i,1982}\\
    &Fatalities_{i,1983} = \beta_0 + \delta_1\mathbbm{1}_{1983} +\beta_1 BeerTax_{i,1983} + \beta_2 Z_i + u_{i,1983}\\
    &Fatalities_{i,1984} = \beta_0 + \delta_2\mathbbm{1}_{1984} +\beta_1 BeerTax_{i,1984} + \beta_2 Z_i + u_{i,1984}\\
    & \cdots\\
    &Fatalities_{i,1988} = \beta_0 + \delta_6\mathbbm{1}_{1988} +\beta_1 BeerTax_{i,1988} + \beta_2 Z_i + u_{i,1988}
\end{eqnarray*}\\[1em]
We do so by taking differences between adjacent time periods:
\begin{equation*}
    \Delta Fatalities_{i,t}= \delta_1 + \Delta\delta_2\mathbbm{1}_{1984}+\cdots+ \Delta\delta_6\mathbbm{1}_{1988}+ \beta_1  \Delta BeerTax_{i,t} + \Delta u_{i,t}
\end{equation*}
\end{frame}
