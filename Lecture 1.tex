...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item $\hat{\mu}_y$ is \textit{more efficient}  than $\tilde{\mu}_y$ if $\var(\hat{\mu}_y) = \var(\tilde{\mu}_y)$
    \end{enumerate}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        & var(\hat{\mu}_y)\geq \mathbb{I}_{\mu_Y}^{-1} = \frac{\sigma_Y}{n} &\text{\vsmall{(Cramer-Rao Inequality + Central Limit Theorem)}}\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Causal Inference, The Mixtape, by Scott Cunningham -- Chapters 1-2
    \end{itemize}
\end{itemize}
\scriptsize{
